      ...
      <div className="home-desktop-1440-px">
        ...
        <div className="stack-11" style={{ padding: '130px 30px 90px 30px' }}>
          <div className="hero-text">
            <div className="hero-main" style={{fontSize: '70px', lineHeight: '60px', fontWeight: '900'}}>About Us</div>
            <div className="hero-sub" style={{fontSize: '30px', lineHeight: '36px', fontWeight: '800', color: '#3d3d3d'}}>
              Founded in 2025, FBX Technologies was born out of a bold vision- to empower the next generation of innovators by making STEM education more accessible, engaging, and effective.
            </div>
          </div>
        </div>
        ...
        <div className="stack-9">
          ...
          <span style={{fontSize: '40px', lineHeight: '36px', fontWeight: '800'}}>We believe </span>  that hands-on learning drives deep understanding. That's why every product we offer is accompanied by a thoughtfully crafted, <b>project-driven curriculum</b> that challenges students to think creatively, solve problems, and build tangible outcomes they can be proud of.
          </div>
          <div className="image-frame">
            <Image 
        ...
        <div className="stack-10">
          <Image 
            className="pranav-photo" 
            src="/images/pranav-photo.png" 
            alt="Pranav Avasarala"
            width={200}
            height={200}
          />
